...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    subscribe: "اشتراك",
    companyDescription:
      "نُحدث تحولاً نوعيًا في خدمات توصيل الطلبات من خلال حلول ذكية وآمنة، تضمن راحة العملاء عبر تجربة خالية تمامًا من التواصل المباشر — لأن الابتكار يبدأ من الثقة.",
    ...
    powerfulAppDesc:
      "تحكّم بكل شيء من خلال تطبيقنا الغني بالميزات، والمصمم ليمنحك تجربة استخدام سلسة ومتكاملة",
    ...
    controlSectionDesc:
      "تابع جميع شحناتك من مكان واحد بكل سهولة عبر تطبيقنا الذكي واستمتع بخدمة توصيل متكاملة، مصمَّمة لراحتك    .",
    controlFeature1: "إشعارات فورية لمتابعة كل تحديث في الوقت الحقيقي",
    controlFeature2: "إدارة متعددة للشحنات في آنٍ واحد بكل مرونة",
    controlFeature3: "حساب عائلي مشترك للتطبيق",
    secureSectionDesc:
      "صناديق Ahln  الذكية لدينا تضمن بقاء طلباتك  آمنة ومحميّة حتى تكون جاهزًا لاستلامها.",
    ...
    processSectionDesc:
      "تم تصميم تجربة التوصيل لدينا لتكون بسيطة وفعّالة، مع ضمان أعلى مستويات الأمان في كل مرة.",
    processFeature1: "رموز دخول آمنة لمرة واحدة تُمنح لمندوبي التوصيل",
    processFeature2: "مقصورات مبرّدة لحفظ المنتجات الحساسة بأفضل الظروف",
    processFeature3: "توصيل بدون تواصل مباشر، حفاظًا على خصوصيتك وسلامتك.",
    processStep1Title: "التحكم عبر التطبيق",
    processStep1Desc:
      "افتح أي باب عن بُعد عند وصول مندوب التوصيل، واستلم إشعارات فورية بالاستلام.",
    processStep2Title: "تسلم الطلبات",
    processStep2Desc:
      "أرسل إلى المندوب رمزاً آمناً وموقعاً، وتلقى إشعاراً عند استخدامه.",
    processStep3Title: "مطابقة رقم التتبع",
    processStep3Desc:
      "سجّل رقم التتبع الخاص بالطلبية  — يُفتح الباب تلقائيًا عند قيام المندوب بمسح رقم التتبع.",
    processStep4Title: "رمز سري مجدول",
    processStep4Desc:
      "اضبط رمزًا متكررًا من خلال التطبيق للطلبات  اليومية. ستتلقى إشعارًا في كل مرة يتم فيها التسليم",
    ...
    secureStorageTitle: "تخزين آمن للطلبات",
    ...
    productMaxName: " الحجم الكبير  Ahln. ",
    productMaxDescription:
      "صندوق التوصيل الذكي المبتكر لدينا صُمم ليتناسب مع احتياجات الفلل الكبيرة، الشركات، والمباني متعددة الوحدات — بفضل أنظمة الأمان المتقدمة وسعة تخزين أكبر",
    ...
    tagTwoYearWarranty: "ضمان سنتين مع قابلية التجديد",
    tagOneYearService: "خدمة ما بعد البيع لمدة سنة",
    tagLargeCapacity: " سعة فائقة للتخزين",
    tagAdvancedSecurity: "تقنيات أمان متطورة",
    ...
    faq1Answer:
      "صُمم Ahln بواسطة Dub Dev Technologies ليكون صندوق توصيل ذكيًا يوفر حلاً عالي التقنية وآمنًا لاستلام الطرود في الفلل أو أماكن العمل دون الحاجة لتدخل مباشر.",
    faq2Question: "كيف يعمل ?",
    faq2Answer:
      "يوفر لك Ahln تجربة تسليم مستقلة وآمنة، من خلال البث المباشر والمراقبة الفورية، مع تطبيق جوال يمنحك التحكم الكامل في أي وقت ومن أي مكان.",
    faq3Question: "هل صندوق آمن؟",
    faq3Answer:
      "يقدم Ahln مستوى متقدمًا من الأمان من خلال مراقبة فيديو ذكية تعتمد على الذكاء الاصطناعي، وتخزين سحابي مشفر، وأقفال إلكترونية عالية الحماية، إلى جانب دعم المصادقة الثنائية، والرموز المؤقتة، والمفاتيح البديلة التقليدية.",
    faq4Question: "هل يمكنني إدارة الصندوق عن بُعد؟",
    faq4Answer:
      "يمكنك إدارة صندوق Ahln عن بُعد بشكل كامل من خلال التطبيق الذكي، حيث يتيح لك التحكم في فتح وإغلاق القفل، متابعة بث الفيديو المباشر، تلقي إشعارات فورية عند التسليم، مشاركة الوصول مع مستخدمين آخرين، وضبط إعدادات  من أي مكان وفي أي وقت، دون الحاجة إلى التواجد الفعلي بجانب الصندوق.",
    ...
    faq14Answer:
      "يتميز Ahln بشاشة لمس مقاس   7.0 بوصة تعمل بنظام أندرويد للتحكم والتفاعل أثناء التسليم.",
    ...
    Send: "إرسال",
    depositPayment: "💰 احجز الآن بدفعة مقدمة",
    tamaraPayment: "🪄 تابي ",
    cardPayment: "💳 بطاقة ائتمان / خصم",
    SelectPaymentMethod: "اختر طريقة الدفع",
    payWithTabby: "ادفع مع تابي",
    payWithDeposit: "اطلب الحين والباقي عند التركيب",
    ...
    differYesterdayToday: "حل ذكي لمشكلة يومية",
    soon: "(قريباً !)",
