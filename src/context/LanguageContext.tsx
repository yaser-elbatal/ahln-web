...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    prebookText: "(Pre Book at ",
    prebookAmount: "1000 - Refundable)",
    ...
    faq16Question: "Is my deposit refundable?",
    faq16Answer:
      "Yes, your deposit is refundable if you cancel before installation.",
    Security: "Security",
    AppControl: "App Control",
    Life: "Life",
    with: "with",
    ...
    Send: "Send",
    depositPayment: "Pre Order",
    RefundableDepositPayment: "Refundable Deposit",
    tamaraPayment: "🪄 tabby",
    cardPayment: "Refundable Deposit",
    SelectPaymentMethod: "Select Payment Type",
    payWithTabby: "Pay with tabby",
    payWithDeposit:
      "Place your order now and pay the remaining balance on delivery",
    ...
    soon: "(soon!)",
    remainingBalance:
      "The remaining balance should be paid before installation",
    estimatedDelivery: "Estimated Delivery: 6 to 8 weeks after placing order",
    refundNote:
      "Deposit is refundable in case of cancellation before installation.",
    viewInstall: " View Installation Specifications →",
  },
  ar: {
    ...
    "companyDescription": "أحدثنا ثورة في عالم التوصيل بحلول آمنة ومريحة وبدون تلامس.",
    ...
    "heroDescription": "مع صندوقٍ ذكي أمام باب منزلك يستقبل طلباتك نيابةً عنك باستخدام أحدث التكنولوجيات وأعلى معايير الأمان.",
    "security": "الأمان",
    "appControl": "التحكم عن طريق التطبيق",
    "liveStream": "البث المباشر",
    "orderNow": "اطلبه الآن!",
    "powerfulAppTitle": "تطبيق محوري",
    "powerfulAppDesc": "تحكم في كل شيء باستخدام تطبيق الهاتف الممتلئ بالمميزات والمصمم لخوض أبسط التجارب.",
    ...
    "featureOfflineDesc": "إمكانية أداء الوظائف الأساسية التي لا تحتاج إلى الإنترنت",
    ...
    "contactPageSubtitle": "إذا كان لديك استفسار، أو احتجت للمساعدة، أو حتى إذا أردت أن تلقي التحية، نسعد بتواصلك معنا.",
    ...
    "subscribeForLatest": "اشترك معنا لتصلك أحدث العروض التوضيحية والفعاليات والمستجدات",
    ...
    "controlSectionDesc": "تتبع جميع طلباتك في مكان واحد مع تطبيقنا للهاتف المحمول المصمم خصيصا لراحتك، احصل على تحديثات فورية وقم بإدارة تفضيلات التسليم بسهولة.",
    ...
    "secureSectionDesc": "صممت صناديقنا الذكية للحفاظ على طلباتك بأمان حتى تصبح بين يديك.",
    ...
    "processSectionDesc": "صممنا عملية التوصيل لتكون سلسلة وسريعة مما يضمن استلام طلباتك بأمان في كل مرة.",
    "processFeature1": "يستطيع مندوبو التوصيل استخدام الصندوق برموز دخول آمنة تُستخدم لمرة واحدة فقط",
    "processFeature2": "حجرات مساحات تخزين مزودة بالقدرة على التحكم بالحرارة لحفظ العناصر الحساسة",
    "processFeature3": "عملية توصيل بدون تلامس للحفاظ على سلامتك",
    "processStep1Title": "التحكم باستخدام التطبيق",
    "processStep1Desc": "افتح أي باب عن بعد عند وصول مندوب التوصيل، وتلق إشعارات لحظية بمحاولة فتحه.",
    "processStep2Title": "مندوبو التوصيل",
    "processStep2Desc": "أرسل إلى السائق رمز تحقق آمن يستخدم لمرة واحدة إضافة إلى الموقع، وتلقَّ إشعارًا فور استخدامه.",
    "processStep3Title": "فتح الباب باستخدام رقم التتبع",
    "processStep3Desc": "سجل رقم التتبع في البرنامج، وسيفتح باب الصندوق تلقائيًا عند مسح رقم التتبع الموجود على الطرد.",
    "processStep4Title": "رمز PIN متكرر",
    "processStep4Desc": "قم بتعيين رمز PIN متكرر للسائقين، وتلقَّ إشعارًا في كل مرة يتم فيها توصيل طلب.",
    "latestHappeningsDesc": "اطلع على تواجد صندوق أهلًا في كبرى الفعاليات والمعارض الصناعية.",
    "watchVideo": "شاهد الفيديو",
    "marketingConsent": "أوافق على تلقي تواصل دعائي وأوافق على سياسة الخصوصية الخاصة بصندوق أهلًا.",
    ...
    "deliveryReimagined": "أحدثنا ثورة في عالم تسليم الطلبات إلى بابك باستخدام أحدث الوسائل التكنولوجية وأكثرها أمانًا.",
    ...
    "appControlStepDesc": "افتح أي باب عن بعد عند وصول مندوب التوصيل، وتلق إشعارات لحظية بمحاولة فتحه.",
    "courierStepTitle": "مندوب التوصيل",
    "courierStepDesc": "أرسل إلى السائق رمز تحقق آمن يستخدم لمرة واحدة إضافة إلى الموقع، وتلقَّ إشعارًا فور استخدامه.",
    "trackingStepTitle": "فتح الباب باستخدام رقم التتبع",
    "trackingStepDesc": "سجل رقم التتبع في البرنامج، وسيفتح باب الصندوق تلقائيًا عند مسح رقم التتبع الموجود على الطرد.",
    "scheduledPinStepTitle": "رمز PIN متكرر",
    "scheduledPinStepDesc": "قم بتعيين رمز PIN متكرر للسائقين، وتلقَّ إشعارًا في كل مرة يتم فيها توصيل طلب.",
    "controlFingertipsDesc": "تتبع جميع شحناتك في مكان واحد مع تطبيقنا للهاتف المحمول المصمم خصيصا لراحتك، احصل على تحديثات فورية وقم بإدارة تفضيلات التسليم بسهولة.",
    "secureStorageDesc": "صممت صناديقنا الذكية للحفاظ على طلباتك بأمان حتى تصبح بين يديك.",
    "seamlessProcessDesc": "صممنا عملية التوصيل لتكون سلسلة وسريعة مما يضمن استلام طلباتك بأمان في كل مرة.",
    ...
    "notificationsDesc": "إشعارات فورية بخصوص الطلبات، وحالة الجهاز، والحالة الأمنية.",
    "familySharingTitle": "المشاركة مع العائلة",
    "familySharingDesc": "شارك إمكانية الوصول إلى الجهاز مع أفراد عائلتك لضمان راحتك.",
    ...
    "livePreviewDesc": "شاهد فيديو مباشر من الكاميرة الخاصة بالصندوق في تطبيق الهاتف",
    "offlineOtpTitle": "إنشاء رمز التحقق يستخدم لمرة واحدة دون الاتصال بالإنترنت",
    "offlineOtpDesc": "يمكنك إنشاء رمز تحقق يستخدم لمرة واحدة لفتح الصندوق حتى إذا لم تكن متصلا بالإنترنت بسبب مشاكل الاتصال.",
    "interactiveViewPrefix": "360°",
    "interactiveViewHighlight": "عرض تفاعلي",
    "dragRotate": "اسحب الشاشة على الجانبين لتحريك الكاميرا، واسحبها لأعلى لتكبير الصورة",
    ...
    "productMaxDescription": "يتميز أحدث صناديقنا للتوصيل الذكي بأنه مثالي للفيلات الكبيرة وبه عدة مساحات تخزين مزودة بإمكانية وصول مزدوج وسعة تخزين أكبر.",
    "productMiniName": "أهلًا ميني",
    "productMiniDescription": "صغير وعملي، ومصمم للاستخدام في الأماكن السكنية أو في المكاتب الصغيرة التي تتطلب توصيلًا آمنا للطلبات.",
    ...
    "faq1Answer": "صندوق أهلًا هو صندوق بريد ذكي طورته شركة Dub Dev Technologies يوفر حلًا آمنًا، ومستقلًا، ومتطورًا لاستلام الطلبات في المنزل أو المكتب.",
    "faq2Question": "كيف يعمل؟",
    "faq2Answer": "يعمل صندوق أهلًا بشكل مستقل باستخدام جداول زمنية محددة للتسليم، ومراقبة فيديو مباشرة، وتطبيق جوال لإدارة استلام الطلبات، حتى إذا لم تكن في المنزل.",
    "faq3Question": "هل الصندوق آمن؟",
    "faq3Answer": "بالطبع، فصندوق أهلًا يدعم مراقبة فيديو مباشرة مدعومة بالذكاء الاصطناعي، وتخزينًا سحابيًا آمنًا للقطات الفيديو، وأقفالًا إلكترونية مقاومة للفتح، وخاصية التحقق الثنائي ورموز الوصول لمرة واحدة عبر الهاتف المحمول، بالإضافة إلى مفاتيح حقيقية عند الحاجة.",
    "faq4Question": "هل يمكنني التحكم في الصندوق عن بعد؟",
    "faq4Answer": "بالتأكيد، يمكنك استخدام تطبيق أهلًا للهاتف المحمول للتحكم في العديد من الأجهزة، ومشاركة إمكانية الوصول إلى الصندوق مع العائلة أو الضيوف، واستلام إشعارات فورية بالتوصيل، والتحكم في إعدادات الأمان والمواعيد.",
    "faq5Question": "ما هو نوع التوصيلات الذي يستطيع الصندوق التعامل معه؟",
    "faq5Answer": "يمكن للصندوق التعامل مع خدمات التوصيل المشهورة مثلًا أمازون وطلبات، يمكنك وضع رقم تتبع الطلب واستلام الطلبات بدون لمس.",
    "faq6Question": "ماذا لو انقطع الاتصال بالانترنت؟",
    "faq6Answer": "يدعم صندوق أهلًا وضع عدم الاتصال الذي يستطيع القيام بالوظائف الأساسية دون الحاجة إلى الاتصال بالإنترنت.",
    "faq7Question": "هل يستطيع الضيوف أو أفراد العائلة استخدام الصندوق؟",
    "faq7Answer": "بالطبع، يمكنك إضافة مستخدمين ضيوف ومشاركة إمكانية الوصول مع أفراد العائلة باستخدام تطبيق الهاتف.",
    "faq8Question": "ما هي أبعاد صندوق أهلًا؟",
    "faq8Answer": "الأبعاد التقريبية: الارتفاع 190 سم، العرض 100 سم، العمق 65 سم.\nيتكوّن من ثلاث حجرات بأحجام مختلفة لتناسب جميع أنواع الطلبات.",
    "faq9Question": "ممّا صُنع صندوق أهلًا؟",
    "faq9Answer": "صنع صندوق أهلًا من الفولاذ المقاوم للصدأ مع طلاء مزدوج بتقنية Powder-Coating لمقاومة التآكل والعوامل الجوية، مع تصنيف حماية IP65 ضد الماء والغبار.",
    "faq10Question": "هل الجهاز مقاوم للعوامل الجوية؟",
    "faq10Answer": "نعم، تصنيف IP65 يضمن مقاومة كاملة للماء والغبار، مما يجعله مثاليًا للاستخدام الخارجي في جميع الظروف.",
    "faq11Question": "ما نوع الاتصال الذي يدعمه أهلًا؟",
    "faq11Answer": "يدعم الاتصال عبر الإيثرنت والواي فاي لضمان تشغيل سلس وتواصل مستمر.",
    "faq12Question": "ما مصدر الطاقة المطلوب لتشغيله؟",
    "faq12Answer": "يعمل صندوق أهلًا على تيار كهربائي 220 فولت تيار متردد ويستهلك حوالي 75 واط فقط.",
    "faq13Question": "ما هي خيارات تركيب الجهاز؟",
    "faq13Answer": "يمكن تثبيت صندوق أهلًا بثلاث طرق: قائم على الأرض، مُثبّت على الجدار، داخل الجدار",
    "faq14Question": "ما حجم شاشة اللمس؟",
    "faq14Answer": "تتميّز شاشة اللمس في صندوق أهلًا بحجم 7 بوصات تعمل بنظام Android للتحكّم السهل والتفاعل مع عمليات التسليم.",
    "faq15Question": "هل توفر أهلًا دعمًا للعملاء؟",
    "faq15Answer": "نعم، نوفّر دعمًا فنيًا مباشرًا وفوريًا عبر الدردشة الحية داخل تطبيق المحمول لتقديم المساعدة في أي وقت.",
    "faq16Question": "هل يمكن استرداد مبلغ العربون؟",
    "faq16Answer": "نعم، العربون قابل للاسترداد في حال إلغاء الطلب قبل عملية التركيب.",
    "Security": "الأمان",
    ...
    "viewInstall": "عرض مواصفات التركيب →",
  },
};
